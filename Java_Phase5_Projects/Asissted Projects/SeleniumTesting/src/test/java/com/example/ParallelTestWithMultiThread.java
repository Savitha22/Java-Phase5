...
public class ParallelTestWithMultiThread {
	...
	public void testOnChromeWithBrowserStackSignUp()
	{
	    ...
	    driver.findElement(By.id("user_full_name")).sendKeys("Savithasini");
	    driver.findElement(By.id("user_email_login")).sendKeys("savithasinik@gmail.com");
	    driver.findElement(By.id("user_password")).sendKeys("Savitha@");
